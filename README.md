...
Given two rolling shutter frames ${\mathbf I}^r_0$ and ${\mathbf I}^r_1$ at adjacent times 0 and 1, CVR can synthesize an intermediate global shutter frame $\hat{\mathbf I}_t^g$ corresponding to any time $t \in [0,1]$, i.e., generating a smooth and coherent global shutter video.
