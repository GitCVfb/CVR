...
parser.add_argument('--batch_sz', type=int, default=4, help='batch size used for training')#4
...
parser.add_argument('--model_label', type=str, default='pretrain', help='label used to load trained CVR models')
parser.add_argument('--model_label_rssr', type=str, default='pretrain_rssr', help='label used to pre-trained RSSR models')

parser.add_argument('--dataset_type', type=str, required=True)
parser.add_argument('--dataset_root_dir', type=str, required=True, help='absolute path for training dataset')
parser.add_argument('--log_dir', type=str, required=True, help='directory used to store trained CVR models (CVPR2022)')
parser.add_argument('--log_dir_rssr', type=str, required=True, help='directory used to store pre-trained RSSR models (See ICCV2021 for training details)')

parser.add_argument('--load_1st_GS', type=bool, default=True)#Load two first-scanline GT GS images?
parser.add_argument('--load_gt_flow', type=bool, default=False)#Load flow of RS -> middle-scanline GS?

parser.add_argument('--lamda_L1', type=float, default=10)
parser.add_argument('--lamda_L1_ccl', type=float, default=5)
